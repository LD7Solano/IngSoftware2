...
<?php include("modulos/contheader.php"); ?>
 ...
 <div class="box">
           ...
           <?php
           $result = mysqli_query($link,"SELECT * FROM pedidos where id");
              $html="  
            <div class='box-body'>
...
while ($fila = mysqli_fetch_array($result)){$x++;
    ...
    $idx=$fila["id"];
             ...
             $html.="<tr role='row' class='odd'>
                  ...
                  <th class='table-active bg-success'><a href='editarMiembro.php?id=$idx'><center><span class='glyphicon glyphicon-edit'></span></center></th>
        <th class='table-active bg-danger'><a href='eliminarMiembro.php?id=$idx'><center><span class='glyphicon glyphicon-trash'></span></center></th>
